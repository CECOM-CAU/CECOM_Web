        ...
        <div className="w-full flex flex-col">
            ...
            <div className="flex flex-col items-center ">
                <div
                    ...
                    {
                        ActivityListData.data.map(({member, mentor, tag, thumbnail, title, id}: ActivityItem) => (
                            <div className="group [perspective:1000px]">
                                <div
                                    className="transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                                    <div className="">
                                        <ActivityCardFront id={id} member={member} mentor={mentor} tag={tag}
                                    ...
                                    <div
                                        ...
                                        <ActivityCardBack title={title} mento={mentor} member={member}
