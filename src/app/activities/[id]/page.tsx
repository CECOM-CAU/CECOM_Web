    ...
    return (
        <div className="flex flex-col mt-[100px] w-full items-center ">
            ...
            <div className='flex flex-row justify-center w-[950px]'>
                <img className="w-[400px] h-[400px] rounded-[20px]"
                     src={'https://velog.velcdn.com/images/kk1112k/post/3c313eca-0dbc-4cd5-b5f8-1ee2f41657d6/79351df114d5d8fa958cbc2065df6877.jpg'}/>
            ...
            <div className="w-[950px] mt-[40px] rounded-[20px] bg-primary-lightgray30 py-[25px] px-[20px]">{contentData.content}</div>
        </div>
    )
}
